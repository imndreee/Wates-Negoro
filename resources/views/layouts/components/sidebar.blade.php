<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if (Request::segment(1) == 'kelola-ktp' || Request::segment(1) == 'tinjau-ktp') active @endif" href="{{ route('kelola-ktp') }}">
                    <i class="ni ni-single-copy-04 text-primary"></i>
                    <span class="nav-link-inner--text">Kelola KTP</span>
                </a>
            </li> --}}
            <li class="nav-item">
