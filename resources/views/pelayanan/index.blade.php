...
@section('content')
    <div class="row">
        <div class="col-md">
            <div id="owl-one" class="owl-carousel owl-theme" style="z-index: 0; background: #fff; border-radius: 10px; padding: 25px 30px;">
                <form action="{{ route('pelayanan.kirim-permintaan') }}" method="post">
                    @csrf
                    <label for="layanan">Pilih Layanan:</label>
                    <select name="layanan" id="layanan">
                        <option value="ktp">Pembuatan KTP baru</option>
                        <option value="kk">Pembuatan Kartu Keluarga</option>
                        <option value="surat_waris">Surat Keterangan Waris</option>
                        <option value="skck">Pembuatan SKCK</option>
                        <option value="pengantar_nikah">Pengantar Nikah</option>
