...
<div class="row">1
        <div class="col-md">
            <div id="owl-one" class="owl-carousel owl-theme"
                ...
                <form action="{{ route('pelayanan.kirim-waris') }}" method="post">
                    @csrf
                    <input type="text" name="layanan" value="surat waris" required readonly hidden>
